...
allHrsArray.array.forEach(element => { element.style.border = "1px solid tomato"
});

// Change the background of all the hr to "antiquewhite" using for of loop.


allHrsArray.array.forEach(element => { element.style.backgroundColor = "antiquewhite" 
});
...
allHrsArray.array.forEach(element => { element.style.borderRadius = "5px" 
});
...
document.querySelectorAll("hr.image").forEach( element => element.style.border = "2px solid purple")
...
allHrsArray.forEach(element => element.style.borderStyle = "dashed")
...
let box16 = document.querySelector(".sixteen").parentNode

let box16 = document.querySelector(".sixteen").childNodes

let box16 = document.querySelector(".sixteen").previousSibling

let box16 = document.querySelector(".sixteen").nextSibling

let box16 = document.querySelector(".sixteen").firstChild

let box16 = document.querySelector(".sixteen").previousElementSibling

let box16 = document.querySelector(".sixteen").nextElementSibling

let box16 = document.querySelector(".sixteen").lastElementChild
...
let box4 = document.querySelector(".six")
...
// Create a img element with src value 
